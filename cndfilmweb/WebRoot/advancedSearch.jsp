		...
		<div id="wrapper">
			...
			<div id="content">
				<div id="advancedSearchContent">
					<div id="searchInnerContent">
						<fieldset class="form-horizontal">
							<div class="control-group">
							  <label class="control-label" for="searchFilmName">节目片名:</label>
							  <div class="controls">
							    <input type="text" style="width:270px;" id="searchFilmName" name="filmName">
							  </div>
							</div>
							<div class="control-group">
							  <label class="control-label" for="searchFilmLength">节目时长:</label>
							  <div class="controls">
							    <input type="text" style="width:270px;" id="searchFilmLength" name="filmLength">
							  </div>
							</div>
							<div class="control-group">
							  <label class="control-label" for="searchFilmTime">出品日期:</label>
							  <div class="controls">
							    <input type="text" style="width:270px;" id="searchFilmTime" name="filmTime">
							  </div>
							</div>
							<div class="control-group">
							  <label class="control-label" for="searchFilmType">节目类型:</label>
							  <div class="controls">
							    <select id="searchFilmType" name="filmType" style="width:100px;">	
							...
							<div class="control-group">
							  ...
							  <div class="controls">
							    <input type="text" style="width:270px;" id="searchStandard" name="standard">
							  </div>
							</div>
							<div class="control-group">
							  <label class="control-label" for="searchFilmKeyword">关键字:</label>
							  <div class="controls">
							    <input type="text" style="width:270px;" id="searchFilmKeyword" name="filmKeyword">
							  </div>
							</div>
							<div class="control-group">
							  <label class="control-label" for="searchDirector">导演（编剧）:</label>
							  <div class="controls">
							    <input type="text" style="width:270px;" id="searchDirector" name="director">
							  </div>
							</div>
							<div class="control-group">
							  <label class="control-label" for="searchAwards">获奖情况:</label>
							  <div class="controls">
							    <input type="text" style="width:270px;" id="searchAwards" name="awards">
							  </div>
							</div>
						</fieldset>
						<a class="btn-style" style="color:#FFFFFF;margin-right:110px;" id="search" href="javascript:void(0);"><strong>确定 Search</strong></a>
					</div>
				</div>
			</div>
