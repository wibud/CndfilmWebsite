			...
			<div id="content">
				<div id="body-content">
					<div class="header-text">
						<ul id="breadcrumbs">
							<li><a>详情 Detail</a></li>
							<li class="current"><a>花絮 Feature</a></li>
						</ul>
						<h2 class="double-color sp" style="color:#454545;"><s:property value="filmDetail.filmName" /></h2>
					</div>
					<div class="detailBlock">
						<div style="margin:0px auto;width:652px;">
							<!--
							<a class="media" href="./mediaplayer/player.swf?file=../uploadFiles/<s:property value="filmDetail.folder_name" />/video/<s:property value="videoName" />"></a>
							-->
							<video width="652" height="360" src="./uploadFiles/<s:property value="filmDetail.folder_name" />/video/<s:property value="videoName" />" type="video/flv" 
								id="player1" poster="" 
