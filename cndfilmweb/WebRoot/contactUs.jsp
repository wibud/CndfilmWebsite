			...
			<div id="content">
				<div id="body-content" class="body-divider">
					<div class="float-left content-left" style="padding-left:10px;padding-top:10px;">
						...
						<h4 class="sub_title">Contact Us</h4>
						<fieldset class="form-horizontal">
							<div class="control-group">
								<label class="control-label" for="userName">您的姓名 Your Name：</label><label id="nameError" class="error hidden"></label>
								<div class="controls">
									<input type="text" style="width:290px;" id="userName"/>
							 	</div>
							</div>
							<div class="control-group">
								<label class="control-label" for="userEmail">您的邮箱 Your Email：</label><label id="emailError" class="error hidden"></label>
								<div class="controls">
									<input type="text" style="width:290px;" id="userEmail"/>
							 	</div>
							</div>
							<div class="control-group">
								<label class="control-label" for="message">内容 Message：</label><label id="messageError" class="error hidden"></label>
								<div class="controls">
									<textarea rows="9" style="width:290px;" id="message"></textarea>
							 	</div>
							</div>
						</fieldset>
						<a class="btn-style" style="color:#FFFFFF;margin-right:30px;" id="sendMessage" href="javascript:void(0);"><strong>确定 Send Message</strong></a>
					</div>
